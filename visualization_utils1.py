...
def draw_bounding_box_on_image(image,
  ...
  if use_normalized_coordinates:
    ...
    cord = (int(left), int(right), int(top), int(bottom))
    #print(cord)
    #roi1 = coordinate[top:bottom,left:right]
    #return coordinate
  else:
...
def visualize_boxes_and_labels_on_image_array(
  ...
  boxes123 = []                #This array holds the values for boundig boxes of total number of car and person objects found
  class_name123 = []           #this array holds name of object 
  classes123 = []              #this array holds class of object
  if not max_boxes_to_draw:
    max_boxes_to_draw = boxes.shape[0]
  for i in range(min(max_boxes_to_draw, boxes.shape[0])):
    if classes[i] == 1:                 #returns bounding box values for only person and car class
          ...
          if not skip_labels:
            if not agnostic_mode:
              if classes[i] in six.viewkeys(category_index):
                ...
                class_name123.append(class_name)
                classes123.append(classes[i])
              else:
                class_name = 'N/A'
  ...
  return image,boxes123,class_name123,classes123                     #boxes value,classes and names of the object found are returned
